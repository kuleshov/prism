...
parser.add_argument('--unphased_blocks')
parser.add_argument('--reference_indices')
parser.add_argument('--reference_panel')
parser.add_argument('--reference_legend')
...
ref_index_file = open(args.reference_indices)
